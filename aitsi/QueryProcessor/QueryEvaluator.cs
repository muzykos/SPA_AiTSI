...
namespace aitsi
{
    ...
    {
        public static string Evaluate(QueryNode tree, PKB.PKB pkb)
        {
        ...
        private static List<string> GetAllPossibleValues(string variable, QueryNode tree, PKB.PKB pkb)
        {
        ...
        //private static List<string> ApplyClause(List<string> currentResults, ClauseNode clause, PKB.PKB pkb)
        //{
        //    return FilterByClause(currentResults, clause, pkb);
        //}

        private static List<string> ApplyWith(List<string> currentResults, WithNode with, PKB.PKB pkb)
        {
        ...
        //private static List<string> FilterByClause(List<string> currentResults, ClauseNode clause, PKB.PKB pkb)
        //{
        ...
        private static List<string> FilterByWith(List<string> currentResults, WithNode with, PKB.PKB pkb)
        {
            List<string> filteredResults = new();
